...
/**
 * @typedef {Object} AuthUtils
 * @property {Function} refreshToken - A function that can be used to update a JWT, if necessary
 * @property {Function} executeAuthenticatedRequest - A function that can use a JWT to authenticate an HTTP request
 */
 ...
 * @param {AuthUtils} [authUtils] - Optional dependency injection of authentication utility functions
 *
 * @return {Promise<[*, TokenOptions]>}
 */
function signAndExecuteRequest(client, url, tokenOptions, requestOptions = {}, authUtils = utils) {
